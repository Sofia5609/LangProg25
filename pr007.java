...
//Получение подробной информацииоб исключении при помощи методов класса Throw
class Pr007 {
	public static void main(String args[]) {
		...
		//catch {...} = блок перехвата исключения
				...
				System.out.println("\nТрассировка стека: ");
				exc.printStackTrace();
				System.out.println("Информация об исключении, представляемая методов toString():");
		...
		*/
		//Использование класса Throwable для обработки всех видов исключений
				...
				System.out.println("Исключение, для которогоне написан специфический обработчик");
			}
		}
	}
}
